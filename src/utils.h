...
template<typename T>
inline bool contains(const std::string &haystack, T needle)
{
	return haystack.find(needle) != haystack.npos;
}

template<typename T>
inline bool contains(const std::string_view &haystack, T needle)
{
	return haystack.find(needle) != haystack.npos;
}
...
public:
	...
	{
		return other.sep != sep || ((other.str.size() || str.size()) && other.str != str);
	}
...
int scan(const std::string &str, const char *format, Args... args)
{
	return sscanf(str.c_str(), format, args...);
}

template<typename... Args>
int scan(const std::string_view &sv, const char *format, Args... args)
{
	return sscanf(std::string(sv).c_str(), format, args...);
}
